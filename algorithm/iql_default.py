...
from networks import Potential as PotentialFunction
import wandb
...
if __name__ == "__main__":
    ...
    parser.add_argument('--method_name', default="IQL_default", type=str)
    ...
    wandb.init(project="BRAC-W2",
        dir = 'wandb2',
        name=f"{args.method_name}_{args.env}",
