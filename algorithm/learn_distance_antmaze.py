...
if __name__ == "__main__":
    ...
    parser.add_argument("--timesteps", default=20001, type=int)     # Num of time steps to update
    ...
    for t in range(int(args.timesteps)):
        ...
        if t % args.eval_freq ==0:
            ...
            wandb.log(log_dict, step=t)
        if (t% 10000) ==0:
            torch.save(method.potential_1.state_dict(), models_path + "-Q(s,rand(s))-l2_10000-8f(s,a).pt")
            torch.save(method.potential_2.state_dict(), models_path + "-Q(s,rand(s))-l2_10000-8g(s,a).pt")
        
    torch.save(method.potential_1.state_dict(), models_path + "-Q(s,rand(s))-l2_20000-8f(s,a).pt")
    torch.save(method.potential_2.state_dict(), models_path + "-Q(s,rand(s))-l2_20000-8g(s,a).pt")
    torch.cuda.empty_cache()
